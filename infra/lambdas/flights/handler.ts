...
import { resolveAircraftType } from '../shared/canonical/semantic/aircraft';
...
async function listOwnFlightsToday(tenantId: string): Promise<APIGatewayProxyResult> {
  ...
  // ICAO type code derivation flows through the canonical aircraft ontology
  // at /shared/semantic/aircraft.ts — no hand-rolled mapping in this Lambda.
