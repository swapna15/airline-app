...
import { ClipboardList, AlertOctagon, GitBranch, FileText, Fuel, Wrench, Users, Zap, ScrollText, DollarSign, CloudLightning } from 'lucide-react';
...
const TABS = [
  ...
  { href: '/planner/sigmet',      label: 'SIGMET',      icon: CloudLightning },
